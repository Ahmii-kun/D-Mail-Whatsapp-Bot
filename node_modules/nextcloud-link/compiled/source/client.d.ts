...
import { configureWebdavConnection, checkConnectivity } from 'nextcloud-link/compiled/source/webdav';
import { getCreatorByFileId, getCreatorByPath } from 'nextcloud-link/compiled/source/common';
import { configureOcsConnection } from 'nextcloud-link/compiled/source/ocs/ocs';
import { OcsSharePermissions, OcsEditUserField, OcsShareType, OcsNewUser, OcsUser } from 'nextcloud-link/compiled/source/ocs/types';
import { NextcloudClientProperties, NextcloudClientInterface, ConnectionOptions } from 'nextcloud-link/compiled/source/types';
export declare class NextcloudClient extends NextcloudClientProperties implements NextcloudClientInterface {
    ...
    activities: {
        get: (fileId: number | string, sort?: 'asc' | 'desc', limit?: number, sinceActivityId?: number) => Promise<import("nextcloud-link/compiled/source/types").OcsActivity[]>;
    };
    users: {
    ...
    shares: {
        ...
        edit: {
            permissions: (shareId: number | string, permissions: OcsSharePermissions) => Promise<import("nextcloud-link/compiled/source/types").OcsShare>;
            password: (shareId: number | string, password: string) => Promise<import("nextcloud-link/compiled/source/types").OcsShare>;
            publicUpload: (shareId: number | string, isPublicUpload: boolean) => Promise<import("nextcloud-link/compiled/source/types").OcsShare>;
            expireDate: (shareId: number | string, expireDate: string) => Promise<import("nextcloud-link/compiled/source/types").OcsShare>;
            note: (shareId: number | string, note: string) => Promise<import("nextcloud-link/compiled/source/types").OcsShare>;
        };
        list: (path?: string, includeReshares?: boolean, showForSubFiles?: boolean) => Promise<import("nextcloud-link/compiled/source/types").OcsShare[]>;
        add: (path: string, shareType: OcsShareType, shareWith?: string, permissions?: OcsSharePermissions, password?: string, publicUpload?: boolean) => Promise<import("nextcloud-link/compiled/source/types").OcsShare>;
        get: (shareId: number | string) => Promise<import("nextcloud-link/compiled/source/types").OcsShare>;
    };
    groupfolders: {
        getFolders: () => Promise<import("nextcloud-link/compiled/source/types").OcsGroupfolder[]>;
        getFolder: (fid: number) => Promise<import("nextcloud-link/compiled/source/types").OcsGroupfolder>;
