...
import { IStickerOptions } from 'wa-sticker-formatter/dist/Types';
...
export declare class Sticker {
     ...
     */
    static extractMetadata: (image: Buffer) => Promise<Partial<import("wa-sticker-formatter/dist/Types").IRawMetadata>>;
}
/**
 *
 * @param {string|Buffer} data - File path, url or Buffer of the image/video to be converted
